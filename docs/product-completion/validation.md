...
- [ ] Loading, empty, forbidden, and failed-request states checked.
- [ ] Role boundaries checked after reload and direct URL access.
- [ ] `pnpm web:lint`, `pnpm web:typecheck`, and `make check` pass.
