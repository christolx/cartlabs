  ...
  return (
    <>
      <PageHeading
        ...
        description="Suspend unsafe listings or reinstate corrected listings. Every action requires a reason."
      />
      {message ? (
      ...
      {!items.length ? (
        <EmptyState
          title="No enforceable listings"
          message="Published and suspended products appear here."
        />
      ) : (
        <div className="moderation-list product-moderation-list">
          {items.map((product) => {
              ...
              <article key={product.id}>
                <header>
                  <div>
                    <h2>{product.name}</h2>
                    <span>
                      {product.storeName || "Seller store"} /{" "}
                ...
                {product.enforcementReason ? (
                  <p className="moderation-note">
                    Latest suspension: {product.enforcementReason}
                ...
                <div className="moderation-actions">
                  <details>
                    <summary>
                      {target === "suspended" ? "Suspend" : "Reinstate"}
                    </summary>
                    <form
