...
function NewProductContent() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    } catch (cause) { setMessage(errorMessage(cause, "Product creation failed. Verified store required.")); }
